...
const elixir_1 = require("../../src/releasers/elixir");
...
mocha_1.describe('Elixir', () => {
    ...
    mocha_1.describe('run', () => {
        mocha_1.it('creates a release PR', async function () {
            const releasePR = new elixir_1.Elixir({
            ...
            const mixContents = fs_1.readFileSync(path_1.resolve(fixturesPath, 'mix.exs'), 'utf8');
