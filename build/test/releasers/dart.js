...
const dart_1 = require("../../src/releasers/dart");
...
mocha_1.describe('Dart', () => {
    ...
    mocha_1.describe('run', () => {
        mocha_1.it('creates a release PR', async function () {
            ...
            const pubspecContents = fs_1.readFileSync(path_1.resolve(fixturesPath, 'pubspec.yaml'), 'utf8');
